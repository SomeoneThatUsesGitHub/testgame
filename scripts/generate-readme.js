...
/**
 * Generate Country Documentation
 * This script creates documentation about adding countries to the application.
 * 
 * Usage: 
...
const readmeContent = `# World Political Map - Country Reference Guide
...
const readmePath = path.join(__dirname, '..', 'COUNTRY_GUIDE.md');
fs.writeFileSync(readmePath, readmeContent);

console.log(`Country documentation has been created at ${readmePath}`);